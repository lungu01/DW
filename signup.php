...
?>
      ...
      <?php if(isset($done)) 
      { ?>
    <div class="successmsg"><span style="font-size:100px;">&#9989;</span> <br> Te-ai logat cu succes! <br> <a href="login.php" style="color:#fff;">Login here... </a> </div>
      <?php } else { ?>
...
<div class="form-group">
  ...
  <button type="submit" name="signup" class="btn btn-primary btn-group-lg form_btn">SignUp</button>
   <p>Aveti cont?  <a href="login.php">LogIn</a> </p>
</form>
<?php } ?> 
</div>
		</div>
